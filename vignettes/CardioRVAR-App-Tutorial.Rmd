...
```{r Figure 3, echo = FALSE, fig.align = "center", fig.caption = "Fig. 3.",out.width="60%", out.height="60%"}
...
```{r Figure 12, echo = FALSE, fig.align = "center", fig.caption = "Fig. 12.",out.width="60%", out.height="60%"}
